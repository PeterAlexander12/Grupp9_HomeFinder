...
namespace HomeFinder.Controllers
{
    ...
    public class AdministratorController : Controller
    {
        ...
        public async Task<IActionResult> EditUser(string id)
        {
            ...
            if(user == null)
            {
                ViewBag.ErrorMessage = $"Användare med ID: {id} kan inte hittas.";
                return View("/");
            }
        ...
        public async Task<IActionResult> EditUser(EditUserVm model)
        {
            ...
            if (user == null)
            {
                ViewBag.ErrorMessage = $"Användare med ID: {model.Id} kan inte hittas.";
                return View("/");
            }
            else
            {
        ...
        public async Task<IActionResult> EditRole(string id)
        {
            ...
            if (role == null)
            {
                ViewBag.ErrorMessage = $"Roll med id = {id} kan inte hittas";
                return View("Error");
            }
        ...
        public async Task<IActionResult> EditRole(EditRoleVm model)
        {
            ...
            if (role == null)
            {
                ViewBag.ErrorMessage = $"Roll med id = {model.Id} kan inte hittas";
                return View("Error");
            }
            else
            {
        ...
        public async Task<IActionResult> EditUsersInRole(string roleId)
        {
            ...
            if(role == null)
            {
                ViewBag.ErrorMessage = $"Roll med id = {roleId} kan inte hittas";
                return View("Error");
            }

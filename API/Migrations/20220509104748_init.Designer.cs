...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("API.Models.RealEstate", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("API.Models.RealEstateImage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("API.Models.RegistrationOfInterest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("API.Models.Favourite", b =>
                {
                    b.HasOne("API.Models.RealEstate", "RealEstate")
                        .WithMany("Favourites")
            ...
            modelBuilder.Entity("API.Models.RealEstate", b =>
                {
                    b.HasOne("API.Models.ApplicationUser", "Broker")
                        .WithMany()
